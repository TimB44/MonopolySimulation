...
public interface BoardObjects {
    ...
    /**
     * This method will be called on a boardObject if the player lands on the object by rolling the dice and moving
     ...
     * @return The position of the player of the interaction with the board object
     */
